                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.levels.index') }}">@lang('site.levels')</a></li>
                    ...
                    <form action="{{ route('dashboard.levels.update', $level->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @foreach(config('translatable.locales') as $locale)
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $locale }}[name]" class="form-control" value="{{ $level->translate($locale)->name }}" required>
                            </div>
                        @endforeach
