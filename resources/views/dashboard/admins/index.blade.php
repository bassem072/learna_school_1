        ...
        <section class="content">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">@lang('site.admins')<small>{{ $admins->total() }}</small></h3><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                @if(auth()->user()->hasPermission('users_create'))
                                    <a href="{{ route('dashboard.admins.create') }}" class="btn btn-info"><i class="fa fa-plus"></i> @lang('site.add')</a>
                                @else
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($admins as $index=>$admin)
                                <tr>
                                    ...
                                    <td>{{ $admin->email }}</td>
                                    <td><img src="{{ $admin->getImagePathAttribute() }}" alt="@lang('site.image_profile')" style="height: 50px;" class="img-thumbnail"></td>
                                    <td>
                                        @if(auth()->user()->hasPermission('users_update'))
                                        <a href="{{ url('dashboard/admins/' . $admin->id . '/edit') }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit')</a>
                                        @else
