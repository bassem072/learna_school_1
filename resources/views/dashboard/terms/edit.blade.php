                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.terms.index') }}">@lang('site.terms')</a></li>
        ...
        <section class="content">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.terms.update', $term->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        @foreach(config('translatable.locales') as $locale)
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $locale }}[name]" class="form-control" value="{{ $term->translate($locale)->name }}" required>
                            </div>
                        @endforeach
