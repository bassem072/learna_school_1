                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('dashboard.teachers.assistants.index', $teacher->id) }}">@lang('site.assistants')</a></li>
        ...
        <section class="content">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('dashboard.teachers.assistants.store', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
