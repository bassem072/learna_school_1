...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Section to manage everything related with the admins panel for the roles and permissions.
    |
    */
    'panel' => [
        /*
        ...
        |--------------------------------------------------------------------------
        |
        | This manages if routes used for the admins panel should be registered.
        | Turn this value to false if you don't want to use Laratrust admins panel
        |
        */
        'register' => false,
